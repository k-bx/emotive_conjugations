# taken from https://raw.githubusercontent.com/explosion/spaCy/master/examples/deep_learning_keras.py
# run like this:
#
#     mkdir -p ~/tmp/emotive_conjugations/data/spacy_keras_model/vocab
#     python ./deep_learning_keras.py ~/tmp/emotive_conjugations/data/spacy_keras_model -L 200
#
...
def train(
    ...
    if persist_vocab_path:
        nlp.vocab.to_disk(persist_vocab_path)
    return model
